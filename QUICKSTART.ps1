...
foreach ($cmd in $checks.Keys) {
    try {
        ...
        Write-Host "   ✓ $($checks[$cmd]) found" -ForegroundColor Green
    } catch {
        Write-Host "   ✗ $($checks[$cmd]) NOT found" -ForegroundColor Red
        $allGood = $false
    }
}
...
Write-Host "Step 1️⃣ : Starting Docker containers..." -ForegroundColor Cyan
...
Write-Host "Step 2️⃣ : Running database migrations..." -ForegroundColor Cyan
...
Write-Host "Step 3️⃣ : Seeding database with sample data..." -ForegroundColor Cyan
...
Write-Host "Step 4️⃣ : Installing backend dependencies..." -ForegroundColor Cyan
...
Write-Host "Step 5️⃣ : Installing frontend dependencies..." -ForegroundColor Cyan
